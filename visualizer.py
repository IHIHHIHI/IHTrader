...
from mplfinacnce.original_flavor import candlestick_ohlc
...
class Visualizer:
    ...
    def __init__(self, vnet=False):
        self.canvas=None
        #캔버스 역할하는 matplotlib의 Figure 객체
        self.fig = None
        #차트를 그리기 위한 matplotlib의 Axes 객체
        self.axes = None
        self.title = '' #그림 제목
    ...
    def plot(self, epoch_str=None, num_epoches=None, epsilon=None,
             action_list=None, actions=None, num_stocks=None, outvals_value=[],
        ...
        with lock:
            ...
            self.axes[1].plot(x, num_stocks, '-k') #보유 주식 그리기
